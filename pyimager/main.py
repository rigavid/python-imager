...
class image:
    ...
    def text(self, txt, pt, colour=COL.red, thickness=1, fontSize=1, angle=0, lineType=0, centered=True, help=False):
        Text(txt).draw(img=self, pt=pt, colour=colour, thickness=thickness, fontSize=fontSize, angle=angle, lineType=lineType, centered=centered, help=help)
    def copy(self):
